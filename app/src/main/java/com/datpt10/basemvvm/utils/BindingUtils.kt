...
import com.datpt10.basemvvm.BuildConfig
...
fun ImageView.loadImage(
    ...
    placeHolder: Drawable? = ContextCompat.getDrawable(this.context, R.drawable.place_holder_01),
    ...
    requestBuilder = if (localImageId != 0) {
        ...
        Glide.with(context).load(localImageId)
            .error(ContextCompat.getDrawable(this.context, R.drawable.place_holder_01))
